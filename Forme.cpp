...
Forme::Forme(int w_, int h_, Point pointForme_, COULEURS couleur_)
    : w(w_), h(h_), pointForme(pointForme_), couleur(couleur_), id(nbFormes) {

  nbFormes++;
}
Forme::Forme(Point pointForme_, COULEURS couleur_)
    : pointForme(pointForme_), couleur(couleur_), id(nbFormes) {
  nbFormes++;
}

Forme::Forme()
    : w(0), h(0), pointForme(), couleur(COULEURS::BLEU), id(nbFormes) {
  nbFormes++;
}
